...
namespace Waterschapshuis.CatchRegistration.External.Api.Tests.TimeRegistrations
{
    ...
    public class TimeRegistrationsControllerFixture : ExternalApiIntegrationFixtureBase
    {
        ...
        {
            var response = await Client.GetAsync<PagedResponse<GetTimeRegistration.TimeRegistrationItem>>("time-registrations");
