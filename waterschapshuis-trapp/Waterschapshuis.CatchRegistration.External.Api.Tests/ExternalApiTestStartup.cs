...
{
    [UsedImplicitly]
    public class ExternalApiTestStartup
    {
        private readonly Startup _startup;
        private readonly IConfiguration _configuration;

        public ExternalApiTestStartup(IConfiguration configuration, IHostEnvironment hostEnvironment)
        {
        ...
        {
            services.AppAddMvc(_configuration, _startup.AuthorizationFeatureEnabled, AssemblyFinder.ExternalApiAssembly)
                .AddApplicationPart(AssemblyFinder.ExternalApiAssembly); // needed only because of tests
