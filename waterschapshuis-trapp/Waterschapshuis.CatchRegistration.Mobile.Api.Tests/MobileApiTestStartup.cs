...
{
    [UsedImplicitly]
    public class MobileApiTestStartup
    {
        private readonly Startup _startup;
        private readonly IConfiguration _configuration;

        public MobileApiTestStartup(IConfiguration configuration, IHostEnvironment hostEnvironment)
        {
        ...
        {
            services.AppAddMvc(_configuration, _startup.AuthorizationFeatureEnabled, AssemblyFinder.MobileApiAssembly)
                .AddApplicationPart(AssemblyFinder.MobileApiAssembly); // needed only because of tests
