...
namespace Waterschapshuis.CatchRegistration.Core.Collections
{
    // BlackWasp's solution: http://www.blackwasp.co.uk/PriorityQueue.aspx
    public class PriorityQueue<TPriority, TItem> where TPriority : notnull
    {
